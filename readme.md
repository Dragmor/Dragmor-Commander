DragmorCommander
DragmorCommander — это графический файловый менеджер, реализованный на Python с использованием библиотеки tkinter. 
Приложение предоставляет интерфейс для управления файлами и папками, поддерживает работу с несколькими панелями и вкладками, а также предлагает возможность подключения сторонних инструментов.
